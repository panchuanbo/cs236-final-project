...
def train(train_A_dir, train_B_dir, model_dir, model_name, random_seed, validation_A_dir, validation_B_dir, output_dir, tensorboard_log_dir):
    ...
    stftA = [librosa.core.stft(a, n_fft=256) for a in wavs_A]
    stftB = [librosa.core.stft(b, n_fft=256) for b in wavs_B]
    ...
    model = CycleGAN(num_features = 129)
    ...
    for epoch in range(num_epochs):
        ...
        dataset_A, dataset_B = sample_train_data(dataset_A = stftA, dataset_B = stftB, n_frames = n_frames)
...
if __name__ == '__main__':
    ...
    train_B_dir_default = './data/vcc2016_training/TF1'
    model_dir_default = './model/sf1_tf1'
    model_name_default = 'sf1_tf1.ckpt'
    random_seed_default = 0
    validation_A_dir_default = './data/evaluation_all/SF1'
    validation_B_dir_default = './data/evaluation_all/TF1'
